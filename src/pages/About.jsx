...
const About = () => {
  return (
    <section className="bg-[#fdf8f3] min-h-screen py-20 px-6 md:px-16">
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <button className="bg-yellow-500 hover:bg-yellow-600 text-white px-8 py-4 rounded-full text-lg font-medium transition-all duration-300 shadow-lg">
            Explore Collection
          </button>
...
//             <div className="bg-white p-6 rounded-2xl shadow-md text-center">
//               <h2 className="text-4xl font-bold text-yellow-500">5K+</h2>
