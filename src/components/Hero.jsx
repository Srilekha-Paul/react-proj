...
//           Discover exquisite jewelry handcrafted with precision and passion.
//         </p>
...
//           <Link
//             to="/shop"
//             className="px-10 py-4 bg-yellow-500 hover:bg-yellow-600 text-white rounded-full text-lg font-medium transition-all"
//           >
//             Shop Collection
//           </Link>
...
//           <Link
//             to="/about"
//             className="px-10 py-4 border border-white text-white rounded-full text-lg font-medium hover:bg-white/10 transition-all"
//           >
//             Learn More
//           </Link>
...
//         {/* Hero Content */}
//         <div className="container text-center relative z-20 px-4 sm:px-6 lg:px-8">
//           <div className="max-w-6xl mx-auto py-20">
//             {/* Main Headline */}
...
//               <span>Luxury</span>
//               <span className="block text-yellow-400 text-5xl sm:text-7xl md:text-8xl lg:text-9xl">Jewels</span>
//             </h1>
...
//             <Link to="/shop"
//               className="group relative inline-flex items-center gap-3 text-lg px-12 py-5 bg-white/20 backdrop-blur-xl hover:bg-white/30 text-white border border-white/30 rounded-full transition-all duration-300"
//              >
//              Shop Now
//             </Link>
//             <Link to="/about"
