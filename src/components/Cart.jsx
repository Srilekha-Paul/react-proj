...
const Cart = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white w-full md:w-96 h-full shadow-2xl flex flex-col"
          ...
          {cart.length === 0 ? (
            <div className="text-center py-12">
              <div className="w-20 h-20 bg-gray-100 rounded-full mx-auto mb-4 flex items-center justify-center">
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-1 4.5A2 2 0 007.4 20h9.2a2 2 0 001.4-3.5l-1-4.5"
                  />
                </svg>
              </div>
              ...
              <Link
                to="/shop"
                onClick={onClose}
                className="inline-block bg-yellow-500 hover:bg-yellow-600 text-white px-8 py-3 rounded-xl font-semibold"
              >
                Start Shopping
              </Link>
            </div>
